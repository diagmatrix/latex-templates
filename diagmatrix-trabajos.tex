...
\section{Marcos y código}
Hola esto es un link: \url{https://github.com/diagmatrix}.
\begin{mdframed}[style=ejemplos]
Para escribir texto dentro de este marco, hay que ponerlo dentro de: \\
\textbackslash begin\{mdframed\}[style=ejemplos]\\
\textbackslash end\{mdframed\}\\
\blindtext
\end{mdframed}
\begin{mdframed}[style=definiciones]
	Para escribir texto dentro de este marco, hay que ponerlo dentro de: \\
\textbackslash begin\{mdframed\}[style=definiciones]\\
\textbackslash end\{mdframed\}\\
\blindtext
\end{mdframed}
\begin{lstlisting}
